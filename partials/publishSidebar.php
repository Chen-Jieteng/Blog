        ...
        <div class="header-box px-2 pt-4">
            <?php if(isset($_SESSION['id'])): ?>
                ...
                <ul class="list-unstyled px-2 text-muted">
                    <li class="pb-5"><a href="#" class="text-deoration-none">发过的文章</a></li>
                    <li class="pb-5"><a href="#" class="text-deoration-none">发过的动态</a></li>
                    <li class="pb-5"><a href="#" class="text-deoration-none">发过的项目</a></li>
                    <li class="pb-5"><a href="#" class="text-deoration-none">用户设置</a></li>
                </ul>
            <?php else: ?>
                <div class="pt-5">
                    <h5>请先登录</h5>
